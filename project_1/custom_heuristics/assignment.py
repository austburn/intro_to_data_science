...
def custom_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        passenger_id = passenger['PassengerId']
        # Admittedly, this was an answer posted to the forum, I found it fairly difficult to generate assumptions
        # on data that I was unfamiliar with how the different variables interacted.

        if passenger['Sex'] == 'female' and passenger['SibSp'] < 3:
            predictions[passenger_id] = 1
        elif passenger['Sex']=='male' and passenger['Age'] < 13 and passenger['Pclass'] < 3:
            predictions[passenger_id] = 1
        elif passenger['Sex']=='male' and passenger['Age'] < 13 and passenger['SibSp'] < 3:
            predictions[passenger_id] = 1
        else:
            predictions[passenger_id] = 0
